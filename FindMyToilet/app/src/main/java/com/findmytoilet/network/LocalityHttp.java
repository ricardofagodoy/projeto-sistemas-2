...
public class LocalityHttp {
    ...
    public void loadLocalities() {
        ...
        localities.add(new Toilet(new LatLng(-22.832587, -47.051994), Sex.MALE, true, false, false, true));
        localities.add(new Toilet(new LatLng(-22.833585, -47.055992), Sex.FEMALE, true, false, false, true));
        localities.add(new Toilet(new LatLng(-22.834582, -47.054990), Sex.UNISEX, true, false, false, false));

        localities.add(new Water(new LatLng(-22.832587, -47.05299), true, false, true));
        localities.add(new Water(new LatLng(-22.835589, -47.05095), true, false, false));
